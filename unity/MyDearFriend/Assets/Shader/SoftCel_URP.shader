    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (Varyings IN) : SV_Target
            {
                ...
                float3 gradientColor = lerp(_GradientColorA.rgb, _GradientColorB.rgb, gradientValue);

                float3 finalColor = lerp(toonColor, toonColor * gradientColor, _GradientStrength);
